...
Main = pd.read_csv("Fuzzy/master/fuzzdat/fuzzydat.csv")
fruits = pd.read_csv("Fuzzy/master/fuzzdat/fruits.csv")
...
#similarly here also
veggies = pd.read_csv("Fuzzy/master/fuzzdat/vegetables.csv")
veggies=veggies.sort_values("Points",ascending=False)
milk = pd.read_csv("Fuzzy/master/fuzzdat/milk.csv")
milk=milk.sort_values("Points",ascending=False)
rice = pd.read_csv("Fuzzy/master/fuzzdat/rice.csv")
